...
namespace BrainMonitor
{
    ...
    // as this header is left in place.
        ...
        public class LomontFFT
        {
            ...
            private static LomontFFT instance = null;
            ...
            public static LomontFFT getInstance()
            {
                if (instance == null) instance = new LomontFFT();
                return instance;
            }
            ...
            public void TableFFT(double[] data, bool forward)
            {
                ...
                if ((n & (n - 1)) != 0)
                   ...
                   n /= 2;    // n is the number of samples //edited out by Erik, 
